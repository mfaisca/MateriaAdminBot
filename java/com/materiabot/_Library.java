...
public class _Library {
	...
	static { //Temporary???
//			SUMMON_LIST.add(new _Summon(Arrays.asList("Chocobo", "Choco"), 20, null, "Chocobo Kick", "Raises party's HP by 250", 
//					"1500 Melee BRV Physical damage" + System.lineSeparator() + "Raises ATK of all party members by 10%", 5, 2000, "Fast"));
//			SUMMON_LIST.add(new _Summon(Arrays.asList("Sylph"), 20, Element.Wind, "Whispering Wind", "Raises Debuff Evasion Rate by 30% when BRV >= Initial BRV", 
//					"1200 BRV and HP recovery" + System.lineSeparator() + "Grants Wind attribute to the party", 5, 2000, "Fast"));
//			SUMMON_LIST.add(new _Summon(Arrays.asList("Ifrit"), 30, Element.Fire, "Hellfire", "Raises Attack by 25% when HP > 80%", 
...
//			SUMMON_LIST.add(new _Summon(Arrays.asList("Shiva"), 30, Element.Ice, "Diamond Dust", "Raises Attack by 15%" + System.lineSeparator() + "Raises Speed by 20% when BRV < Initial BRV.", 
...
//			SUMMON_LIST.add(new _Summon(Arrays.asList("Ramuh"), 30, Element.Thunder, "Judgement Bolt", "Raises Max BRV by 15%" + System.lineSeparator() + "Raises Defense by 40% when HP < 80%", 
...
//			SUMMON_LIST.add(new _Summon(Arrays.asList("Leviathan", "Levi"), 30, Element.Water, "Tidal Wave", "Lowers enemy Speed by 10%" + System.lineSeparator() + "Grants 60% Initial BRV Regen when HP < 80%", 
...
//			SUMMON_LIST.add(new _Summon(Arrays.asList("Brothers"), 30, Element.Earth, "Brotherly Love", "Raises Max BRV by 25% when HP > 50%", 
...
//			SUMMON_LIST.add(new _Summon(Arrays.asList("Pandemonium", "Pandemona", "Pande", "Panda"), 30, Element.Wind, "Tornado Zone", "Raises HP and BRV damage by 25% during a Chase Sequence", 
...
//			SUMMON_LIST.add(new _Summon(Arrays.asList("Alexander", "Alex"), 20, Element.Holy, "Divine Judgment", "Raises Max HP by 15%" + System.lineSeparator() + "Grants 15% HP Regen for 10 turns when HP < 60%",
...
//			SUMMON_LIST.add(new _Summon(Arrays.asList("Diabolos", "Diablos", "Dia"), 30, Element.Dark, "Dark Messenger", "Raises Initial BRV by 30%" + System.lineSeparator()
...
//			SUMMON_LIST.add(new _Summon(Arrays.asList("Odin"), 30, null, "Zantetsuken", "Decreases DEF of all enemies by 15%" + System.lineSeparator() + "After HP drops below 80%, permanently increases ATK by 30%.", 
...
//			SUMMON_LIST.add(new _Summon(Arrays.asList("Bahamut", "Baha"), 30, null, "Megaflare", "All enemies 15% Attack Down" + System.lineSeparator() + "Raises BREAK Bonus by 10% after an enemy is broken (up to 100%)", 
...
//			SUMMON_LIST.add(new _Summon(Arrays.asList("Spirit Moogle", "Spirit Mog", "Moogle", "Mog"), 20, null, "Don't fluff me, kupo~", "Increases Terra's Affection by 10", 
