...
public class Ramuh40 extends _Summon{
	protected Ramuh40() {
		super(Arrays.asList("Ramuh"), 40, Element.Thunder, "Judgement Bolt+", 
				"Raises Max BRV by 15%" + System.lineSeparator() + "Raises Defense by 80% after hitting HP < 80% once", 
					"Lightning BRV-HP Magic damage" + System.lineSeparator() + 
					"Grants Lightning attribute to the party" + System.lineSeparator() + 
					"Party +10% Maximum BRV damage limit" + System.lineSeparator() + 
					"Inflict on all enemies " + ImageUtils.getEmoteText("ailmentSilver") + ImageUtils.getAilmentEmote(5, -1, true, -1, -1) + Methods.enframe("Judgement Bolt") + " for 1 turns:" + System.lineSeparator() + 
					"\tUnable to act", 
