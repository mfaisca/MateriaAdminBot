...
public class Alexander30 extends _Summon{
	protected Alexander30() {
		super(Arrays.asList("Alexander", "Alex"), 30, Element.Holy, "Divine Judgment", 
				"Raises Max HP by 15%" + System.lineSeparator() + "Grants 15% HP Regen for 10 turns after hitting HP < 80% once", 
					...
					"Grants Holy attribute to the party",
