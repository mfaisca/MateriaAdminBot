...
public class Pandemonium30 extends _Summon{
	protected Pandemonium30() {
		super(Arrays.asList("Pandemonium", "Pandemona", "Panda"), 30, Element.Wind, "Tornado Zone", 
				"Raises BRV and HP damage by 25% during a Chase Sequence", 
					"Wind BRV Magic damage" + System.lineSeparator() + 
