...
public class Bahamut40 extends _Summon{
	protected Bahamut40() {
		super(Arrays.asList("Bahamut", "Baha"), 40, Element.Null, "Megaflare", 
				"All enemies 15% Attack Down" + System.lineSeparator() + "Raises BREAK Bonus by 50% after an enemy is broken (up to 200%)", 
					"Non-elemental BRV-HP Magic damage" + System.lineSeparator() + 
					"Raises non-elemental BRV damage by 100%" + System.lineSeparator() + 
					"Party +10% Maximum BRV damage limit" + System.lineSeparator() + 
					"Grants Party " + ImageUtils.getEmoteText("ailmentSilver") + ImageUtils.getAilmentEmote(17, -1, false, -1, -1) + Methods.enframe("Megaflare") + " for 1 turns:" + System.lineSeparator() + 
					"\tRefill EX Gauge", 
