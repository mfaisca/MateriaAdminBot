...
public class Diabolos40 extends _Summon{
	protected Diabolos40() {
		super(Arrays.asList("Diabolos", "Diablos", "Diablo"), 40, Element.Dark, "Dark Messenger+", 
				"Raises Initial BRV by 50%" + System.lineSeparator()
				+ "+50% BRV Damage when hitting elemental weakness after hitting HP < 80% once", 
					"Dark BRV-HP Magic damage" + System.lineSeparator() + 
					"Grants Dark attribute to the party" + System.lineSeparator() + 
