...
public class Shiva40 extends _Summon{
	protected Shiva40() {
		super(Arrays.asList("Shiva"), 40, Element.Ice, "Diamond Dust+", 
				"Raises Attack by 15%" + System.lineSeparator() + "Raises Speed by 20%" + System.lineSeparator() + "Raises EX Recast by 5%", 
					"Ice BRV-HP Magic damage" + System.lineSeparator() + 
					"Grants Ice attribute to the party" + System.lineSeparator() + 
					"Party +10% Maximum BRV damage limit" + System.lineSeparator() + 
					"Inflict on all enemies " + ImageUtils.getEmoteText("ailmentSilver") + ImageUtils.getAilmentEmote(8, -1, true, -1, -1) + Methods.enframe("Diamond Dust") + " for 1 turns:" + System.lineSeparator() + 
					"\tUnable to gain BRV", 
