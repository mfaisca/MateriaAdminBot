...
public class ValType16 extends _ValType{
	...
	@Override
	public Integer[] getValues(Ailment ailment, int index, int rank) { //Returns all rank_data for stack-based ailment on target
		Ailment t = ailment.getUnit().getAilments().get(ailment.getValSpecify()[index]);
		Integer[] ret = new Integer[t != null ? t.getMaxStacks() : 10];
